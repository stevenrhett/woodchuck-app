...
const Footer = () => {
    ...
    return (<>
            <footer className="bottom-2 bg-slate-800 footer rounded-lg p-0.5 ">
                <div
                    ...
                    <div className="w-full lg:w-6/12 lg:text-lg">
                        <div className="sm:mb-2 mt-2 ">
                            <ul className="text-gray-100 font-semibold brightness-100 text-center justify-between columns-3">
