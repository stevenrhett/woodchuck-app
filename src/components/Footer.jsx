...
const Footer = () => {
    ...
    return (<>
            <footer className="wrapper footer rounded-lg p-0.5 bg-base-100 text-base-content">
                <div
                    className="mx-auto flex flex-wrap items-center justify-between max-w-screen-lg sm:px-4 lg:px-8">
                    <div className="lg:mb-0 w-full lg:w-6/12 lg:mb-0">

                        <h1 className="font-semibold brightness-100 lg:mb-0 block ml-6 text-3xl text-gray-100">
                            Service Area
                        </h1>
                    </div>
                    <div className="w-full  lg:w-6/12 lg:text-lg">
                        <div className="sm:mb-2 mt-2 text-gray-100">
                            <ul className="font-semibold brightness-100 text-center justify-between columns-3">
                    ...
                    <div className="flex flex-col sm:flex-row  lg:justify-between lg:items-center">
                        ...
                        <div className="grid-flow-col gap-0 place-self-center justify-self-end">
