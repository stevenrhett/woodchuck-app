...
const towns = [
    {town: 'Abington', id: 0o1},
    {town: 'Braintree', id: 0o1},
    {town: 'Canton', id: 0o1},
    {town: 'Carver', id: 0o1},
    {town: 'Cohasset', id: 0o1},
    {town: 'Duxbury', id: 0o1},
    {town: 'Halifax', id: 0o1},
    {town: 'Hanson', id: 0o1},
    {town: 'Hanover', id: 0o1},
    {town: 'Hingham', id: 0o1},
    {town: 'Holbrook', id: 0o1},
    {town: 'Hull', id: 0o1},
    {town: 'Marshfield', id: 0o1},
    {town: 'Milton', id: 0o1},
    {town: 'Norwell', id: 0o1},
    {town: 'Pembroke', id: 0o1},
    {town: 'Plympton', id: 0o1},
    {town: 'Quincy', id: 0o1},
    {town: 'Randolph', id: 0o1},
    {town: 'Rockland', id: 0o1},
    {town: 'Scituate', id: 0o1},
    {town: 'Weymouth', id: 0o1},
    {town: 'Whitman', id: 0o1},];
...
const Footer = () => {
    ...
    return (<>
        <footer className="bottom-2 bg-slate-700 footer rounded-md p-0.5 ">
            <div
                    ...
                    <div className="sm:mb-4 ">
                        <div
                            ...
                            {towns.map((town, index) => {
                                return (
                                    <ul key={index} className="text-gray-100 font-semibold text-center">
