...
import WorkTruck from "/src/assets/woodchuck-logo.svg";
import vector from '/src/assets/Vector-blue.svg';

export default function Contact() {

    return (<div className="relative bg-white">
        <div className="lg:absolute lg:inset-0">
            <div className="lg:absolute lg:inset-y-0 lg:right-0 w-1/2">
                <img src={WorkTruck} alt="Work Truck"
                     className="h-90 w-full opacity-80 object-contain lg:absolute"/>
                <img src={vector} alt="Work Truck"
                     className="sm:-mt-20 opacity-60 object-contain lg:mt-60 h-20 w-1/2"/>
            </div>
        </div>
        <div
