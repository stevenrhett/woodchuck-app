...
const footerNavigation = {
    social: [{
        name: 'Facebook', href: 'https://www.facebook.com/', icon: (props) => (<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
                fillRule="evenodd"
        ...
        name: 'Instagram', href: 'https://www.instagram.com/', icon: (props) => (<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
                fillRule="evenodd"
        ...
        name: 'Twitter', href: 'https://www.twitter.com/', icon: (props) => (<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
        ...
        {
            name: 'Dribbble', href: 'https://www.dribbble.com/', icon: (props) => (<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
                    fillRule="evenodd"
                ...
                <div className="mx-auto max-w-md py-12 px-6 sm:max-w-3xl sm:py-24 lg:max-w-7xl lg:px-8">
                    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div className="space-y-8 xl:col-span-1">
                            ...
                            <div className="flex justify-center -mt-8 -mb-16 space-x-6 ">
                                {footerNavigation.social.map((item) => (<a key={item.name} href={item.href}
                                                                           className="text-white hover:text-red-100 sm:-mb-10">
