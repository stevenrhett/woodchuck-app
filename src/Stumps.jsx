...
export default function Stumps() {
    return (<div className="carousel h-screen rounded bg-neutral lg:rounded-box">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-20 top-10">
                <div className="absolute animate-bounce hover:bg-primary bg-primary btn btn-circle w-24 h-20">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="h-8">
        ...
        <div className="carousel-item lg:w-full relative object-cover">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-48 top-10">
                <div className="animate-pulse absolute  hover:bg-primary bg-primary btn btn-circle h-20 w-24">
